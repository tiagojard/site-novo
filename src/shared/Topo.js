...
class Topo extends Component {
  ...
  handleSubmit(e){
    window.location.href = "/busca/"+e.target.querySelector("input").value;
  ...
  render(){
    return (
        <div className="conteiner-topo">
            <form id="busca-mobile" onSubmit={this.handleSubmit} className="topo-busca-mobile">
            ...
            <div id="topo" className="topo">
                ...
                <form className="topo-busca" onSubmit={this.handleSubmit}>
                    <div className="logo-nome"><a href="/" title="Home">Guia do desenvolvedor</a></div>
                    <span className="topo-busca-nome-site"><a href="/" title="Home">Guia do desenvolvedor</a></span>
                    <div className="busca">
                  ...
                  <li>
                    <div className="dropdown">
                      ...
                      <div className="dropdown-content">
                        <a href="/busca/assunto/CSharp" title="CSharp">CSharp</a>
                        <a href="/busca/assunto/JavaScript" title="javaScript">javaScript</a>
                        <a href="/busca/assunto/Jquery" title="Jquery">Jquery</a>
                        <a href="/busca/assunto/Node.js" title="Node.js">Node.js</a>
                        <a href="/busca/assunto/SQL Server" title="SQL Server">SQL Server</a>
                        <a href="/busca/assunto/React js" title="React js">React js</a>
                      </div>
                    </div>
                  </li>
                </ul>
